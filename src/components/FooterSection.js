        ...
        return (
            <Footer style={Styles.footer}>
                <FooterTab style={Styles.footerTab} >
                    ...
                    <Button onPress={()=> this.props.navigation.navigate("addAd")} style={{  borderWidth:2 , borderColor:this.state.routeName === 'addAd' ? "#FFCC00" : "transparent" , backgroundColor: this.state.routeName === 'addAd' ? "#FFCC00" : "#fff" , borderRadius: 50, bottom: 1, width: 50, height: 50 , position:'absolute', alignItems: 'center', justifyContent: 'center', right: '42.9%'}}>
