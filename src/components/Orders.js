            ...
            <Container style={{}}>
                ...
                <Content style={{padding:15}}>
                    <View style={Styles.orerBtns}>
                        <TouchableOpacity  style={[Styles.touchModal , {backgroundColor:'#035F5B', width:120 , marginRight:-30 , zIndex:1}]}>
                            <Text style={[Styles.headerBody , {fontSize:14}]}>طلباتي</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('myAdds')} style={[Styles.touchModal , {backgroundColor:'#F6F6F6', width:120 , borderColor:'#eee' , borderWidth:1}]}>
                            <Text style={[Styles.headerBody , {fontSize:14 , color :'#035F5B'}]}>اعلاناتي</Text>
                        </TouchableOpacity>
                    </View>
